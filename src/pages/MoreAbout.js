        ...
        <div className='more-about-wrap'>
          <NavBar></NavBar>
            <div className='body'>
                ...
                <div className='work-experience'>
                    <div className='job-time'>
                        ...
                        <p className='work-time'>09/2021-6/2022</p>
                    </div>

                    <h4 className='company'>
                        元智大學宿舍服務組
                    </h4>
                    <p className='location'>工讀生|桃園市中壢區
                    </p>
                    <p className='job-description'>
                        文書處理。
                        負責中英翻譯及協助處理外籍生住宿問題。
                ...
                <div className='work-experience'>
                    <div className='job-time'>
                        ...
                        <p className='work-time'>02/2020-6/2021</p>
                    </div>
                ...
                <div className='language'>
                    ...
                    <h4 className='skills'>聽/精通說/精通讀/精通寫/精通</h4>
                    <p className='test'>華語文能力測驗-聽讀流利精通級 C1
                    </p>
                </div>
                <div className='language'>
                    <h3 className='language-name'><u>英文</u></h3>
                    <h4 className='skills'>聽/精通說/精通讀/精通寫/精通</h4>
                    <p className='test'>TOEIC (多益測驗) 825
                    </p>
                </div>
                <div className='language'>
            ...
            <div className='back-container'>
                <a href="/" className='link'><button className='back'>回到首頁
                </button></a>
            </div>
